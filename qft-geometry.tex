...
path integrals we are computing involve 
...
Thus our job is to make sense of the limit of the operator $A$, and its determinant,
as $N \to \infty$.

\fixme{say this also works more generally, not only for completely Gaussian models}
