...
\begin{equation}
  Z = \int_M \frac{\omega^n}{n!} \e^{\I \alpha H}. 
\end{equation}
\begin{example}
...
and thus
\begin{align}
  Z &= 2 \pi \int_0^\pi \e^{\I \alpha \cos \theta} \sin \theta \, \de \theta \\
  &= -2 \pi \int_{1}^{-1} \e^{\I \alpha z} \de z \\
  &= -2\pi \I \alpha^{-1} (\e^{\I \alpha} - \e^{-\I \alpha}) \\
...
(\pm \I) \frac{2\pi}{\alpha \sqrt{\abs{\det H''(x_c)}}} \e^{\I \alpha H(x_c)}. 
\end{equation}
...
\begin{equation}
\int_M \frac{\omega^n}{n!} \e^{\I \alpha H} = \left( \frac{2\pi}{\alpha} \right)^{n} \sum_{x_c} \e^{\frac{\pi \I}{4} (n_+(x_c) - n_-(x_c))} \frac{\e^{\I \alpha H(x_c)}}{\sqrt{\abs{\det H''(x_c) / \omega^n}}}
\end{equation}
\end{thm}
