...
\begin{equation}
   \hat p = 2 \partial_x
\end{equation} 
on $L^2(\R)$. \fixme{check sign} \fixme{change conventions
somehow so that this $2$ goes away}
\end{prop}
...
``is the heat kernel for'') \fixme{switch to a better notation}
\begin{equation}
...
\begin{equation}
  2 \int \de y_1 \de y_2 \de y_3 \, \e^{-F(y)}.
\end{equation}
