...
\end{equation}
and if $X = f^i \partial_{x^i} + g^I \partial_{\psi^I}$ relative to a basis of $V$, 
then
\begin{equation}
...
\begin{align}
  ...
  &= \int \de \vec{x} \, ((\partial_{\psi^I} g^I) f^\rmtop + f^i \partial_{x^i} f^\rmtop) \\
  &= \int \de \vec{x} \, (\partial_{\psi^I} g^I - \partial_{x^i} f^i) f^\rmtop \\
  &= 0 
\end{align}
where we integrated by parts, using the compact support of $f$, in the third line.
\end{pf}
