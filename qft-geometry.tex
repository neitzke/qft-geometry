...
\begin{equation}
  \left\{0, \frac{2 \pi^2}{R^2}, \frac{2 \pi^2}{R^2}, \frac{8 \pi^2}{R^2}, \frac{8 \pi^2}{R^2}, \dots \right\}
\end{equation}
Thus the partition function on $X = S^1(T)$ is
\begin{equation}
...
\begin{exercise} Give a formula for the $N \times N$ matrix $A$ which appears
in the discretization of the path integral of 
\autoref{exa:harmonic-oscillator}. Check (at least numerically) that $1 / \sqrt{\det A}$
...
Thus our job is to make sense of the limit of the operator $A$, and its determinant, as $N \to \infty$.
It appears that the correct interpretation is as follows.
...
function $M = 2S$ are
\begin{equation}
  \omega^2 T^2, \qquad 1 + \frac{\omega^2 T^2}{4 \pi^2 n^2}, 1 + \frac{\omega^2 T^2}{4 \pi^2 n^2}, 
\end{equation}
