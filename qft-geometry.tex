...
This is indeed true, but there is a surprising twist:
...
\begin{exercise} Show that $\Spin(V)$ acts on $V \subset \Cliff(V)$ 
...
up to equivalence form a \ti{torsor} for the group $H_1(X, \Z/2\Z)$.
(Hint: $H_1(X, \Z/2\Z)$ classifies double covers of $X$ up to equivalence, and 
