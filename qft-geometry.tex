...
\begin{equation} \label{eq:correlation-hamiltonian}
	\IP{\cO_1(t_1) \cO_2(t_2) \cdots \cO_n(t_n)}_{S^1(T)} = \Tr_{\cH} \e^{-t_1 H} \hat\cO_1 \e^{-(t_2 -t_1) H} \hat\cO_2 \cdots \hat\cO_n \e^{-(T-t_n) H}.
\end{equation}
...
scalar curvature.
The $H$ we choose in \eqref{eq:h-spinorial} is singled out
