...
Suppose $(M, \omega)$ is a compact symplectic manifold, with a $U(1)$ action
generated by a Hamiltonian $H$, i.e. the vector field is
\begin{equation}
  Y = \omega^{-1}(\de H).
\end{equation}
...
% \begin{equation}
% \int_M \omega^n \e^{-H} = \sum_{x_c} \frac{\e^{-H(x_c)}}{\prod_i \lambda_i(x_c)}
% \end{equation}
% \end{thm}
