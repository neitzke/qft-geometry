...
\begin{equation}
  \cC = \Pi T \Map(X,Y).
\end{equation}
One immediate observation is that here we have (at least formally) a \ti{canonical}
...
\end{equation}
These two obey the \ti{$1$-dimensional supersymmetry algebra}
\begin{equation}
  [Q,Q] = 2H.
\end{equation}
