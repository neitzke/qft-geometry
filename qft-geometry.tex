...
by the transition functions of $P$. Some people would call this bundle $\ad P$.} locally written
...
These invariants proved very powerful \fixme{explain something proved using them?} but also very technically
...
\end{itemize}
where $S^\pm$ are the spin representations of $\Spin(4)$.
